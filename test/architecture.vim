function! QuadarTest_RunArchitecture() abort
  ...
  call QuadarTest_AssertTrue(filereadable('Makefile'), 'Repo should expose make targets for the test workflow.')
  ...
  let l:state_file = QuadarTest_Path('story_state')
  let l:records_file = QuadarTest_Path('story_records')
  let l:threads_file = QuadarTest_Path('story_threads')
  let l:story_cards_file = QuadarTest_Path('story_cards')
  ...
  let l:quest_file = QuadarTest_Path('quest')
  ...
  call QuadarTest_AssertFileContains(l:quest_file, 'function! game#quest#ensure', 'quest.vim must expose quest creation through a dedicated lifecycle module.')
  call QuadarTest_AssertFileContains(l:quest_file, 'function! game#quest#advance', 'quest.vim must expose quest advancement through a dedicated lifecycle module.')
  call QuadarTest_AssertFileContains(l:quest_file, 'quest/completed', 'quest.vim should emit typed quest lifecycle events on completion.')
  call QuadarTest_AssertFileContains(l:quest_file, 'quest/replaced', 'quest.vim should reserve a typed event for replaced quests.')
  call QuadarTest_AssertFileContains(l:records_file, 'game#quest#advance', 'story/records.vim should delegate quest advancement to the quest lifecycle module.')
  call QuadarTest_AssertFileContains(l:records_file, 'game#quest#ensure', 'story/records.vim should delegate quest creation to the quest lifecycle module.')
  call QuadarTest_AssertFileNotContains(l:records_file, 'REWARD ITEM:', 'story/records.vim should not deliver quest rewards inline anymore.')
  call QuadarTest_AssertFileContains(l:interact_file, 'game#quest#advance', 'interact.vim should route quest progress through the quest lifecycle module.')
  call QuadarTest_AssertFileContains(l:interact_file, 'game#quest#ensure', 'interact.vim should route quest creation through the quest lifecycle module.')
  call QuadarTest_AssertFileContains(l:enemies_file, 'game#quest#advance', 'enemies.vim should route climax quest completion through the quest lifecycle module.')
  ...
  call QuadarTest_AssertFileContains(l:story_cards_file, 'function! game#story#cards#new_scene', 'story/cards.vim must expose a scene-card constructor.')
  call QuadarTest_AssertFileContains(l:story_cards_file, 'function! game#story#cards#normalize_scene', 'story/cards.vim must expose scene-card normalization.')
  call QuadarTest_AssertFileContains(l:story_cards_file, 'function! game#story#cards#new_thread', 'story/cards.vim must expose a thread-card constructor.')
  call QuadarTest_AssertFileContains(l:story_cards_file, 'function! game#story#cards#new_npc', 'story/cards.vim must expose an NPC-card constructor.')
  call QuadarTest_AssertFileContains(l:state_file, 'game#story#cards#new_notes()', 'story/state.vim should source note-card containers from the shared card constructors.')
  call QuadarTest_AssertFileContains(l:state_file, 'game#story#cards#normalize_scene', 'story/state.vim should normalize scene cards through the shared card constructors.')
  call QuadarTest_AssertFileContains(l:state_file, 'game#story#cards#normalize_npc', 'story/state.vim should normalize NPC cards through the shared card constructors.')
  call QuadarTest_AssertFileContains(l:threads_file, 'game#story#cards#new_thread', 'story/threads.vim should create thread cards through the shared card constructors.')
  call QuadarTest_AssertFileContains(l:threads_file, 'game#story#cards#normalize_thread', 'story/threads.vim should normalize thread cards through the shared card constructors.')
  call QuadarTest_AssertFileContains(l:records_file, 'game#story#cards#new_scene', 'story/records.vim should create scene cards through the shared card constructors.')
  call QuadarTest_AssertFileContains(l:records_file, 'game#story#cards#normalize_scene', 'story/records.vim should normalize scene cards through the shared card constructors.')
  call QuadarTest_AssertFileContains(l:records_file, 'game#story#cards#new_npc', 'story/records.vim should create NPC cards through the shared card constructors.')
